            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="product-details">
                        ...
                        <div>
                            <h3 class="product-price">{{ number_format($data->price - ($data->price * $data->sale) / 100) }}
                                <del class="product-old-price">{{ number_format($data->price, 0, ',', '.') }} Đ</del>
                            </h3>
                            <span class="product-available">còn lại:{{ $data->stock }}</span>
                        </div>
